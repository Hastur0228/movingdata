...
template<class KEY, class OTHER>
void binarySearchTree<KEY, OTHER>::destroy(BinaryNode* currentroot)
{
    if (currentroot)
    {
...
template<class KEY, class OTHER>
SET<KEY,OTHER>* binarySearchTree<KEY,OTHER>::findKth(int i)
{
